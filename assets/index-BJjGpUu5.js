...
`)}function JE(e){let t=KE(e.telefone);return t===``?``:`https://wa.me/${t}`}async function YE(e){if(e.nome===``&&e.telefone===``)return``;let{default:t}=await w(async()=>{let{default:e}=await import(`./qrcode-DtWdxa9d.js`);return{default:e}},[],import.meta.url),n=t(0,`M`);return n.addData(qE(e)),n.make(),n.createDataURL(6,8)}function XE(e){return e.nome!==``||e.tipoSanguineo!==``||e.doadorOrgaos===1||e.gravida===1||e.alergias!==``||e.medicamentosEmUso!==``||e.contatoEmergencia!==``||e.nomeColih!==``}function ZE(e){let t=e.dataPrevistaParto.trim();if(t===``)return``;let[n,r,i]=t.split(`-`);return n!==void 0&&r!==void 0&&i!==void 0?`${i}/${r}/${n}`:t}var QE=864e5;function $E(e){if(e.dpaAssinadoEmEpoch===0)return null;let t=e.dpaAssinadoEmEpoch+365*QE;return{data:new Date(e.dpaAssinadoEmEpoch).toLocaleDateString(`pt-BR`),dias:Math.ceil((t-Date.now())/QE)}}var eD=1e3,U={...VE},tD=``,nD=``,rD=!1,iD=!1,aD;function oD(){rD||iD||(iD=!0,(async()=>{try{U=await WE(),tD=await YE(U),rD=!0}finally{iD=!1,C()}})())}function sD(){nD=n.acervo.salvando,C(),clearTimeout(aD),aD=setTimeout(()=>void cD(),eD)}async function cD(){U=await GE(U),tD=await YE(U),nD=n.acervo.salvoAs(Gd(Date.now())),C()}function lD(e,t){U={...U,[e]:t},sD()}function uD(e,t,n=`text`){return b`
  ...
  `}function cN(){return b`
    <button
      class="tile"
      style="--cor: #20c997"
      @click=${async()=>{let{abrirConvite:e}=await w(async()=>{let{abrirConvite:e}=await import(`./convite-C8mYOIkE.js`);return{abrirConvite:e}},__vite__mapDeps([72,73,74]),import.meta.url);await e()}}
    >
...
`,KN,qN,JN,YN,XN,ZN,QN=class extends (JN=ei,qN=[D({reflect:!0})],KN=[D({reflect:!0})],JN){constructor(){super(...arguments),v(this,`hasSlotController`,new eo(this,`footer`,`header`,`image`)),y(this,XN,g(YN,8,this,`vertical`)),g(YN,11,this),y(this,ZN,g(YN,12,this,`default`)),g(YN,15,this)}render(){return T`
      <div
        part="base"
        class=${Vi({card:!0,"card--horizontal":this.orientation===`horizontal`,"card--has-footer":this.hasSlotController.test(`footer`),"card--has-image":this.hasSlotController.test(`image`),"card--has-header":this.hasSlotController.test(`header`),"card--variant":this.variant!=="default",[`card--${this.variant}`]:this.variant!=="default"})}
      >
    ...
    `}};YN=ge(JN),XN=new WeakMap,ZN=new WeakMap,_(YN,4,`orientation`,qN,QN,XN),_(YN,4,`variant`,KN,QN,ZN),be(YN,QN),v(QN,`styles`,[Fr,GN]),QN.define(`st-card`),oc.define(`st-dialog`),Kc.define(`st-dropdown`);var $N=pr`
  :host {
    display: block;
...
`,tP,nP,rP,iP,aP,oP,sP,cP,lP,uP,dP,fP,pP,mP,hP,J,gP,_P,vP,yP,bP,xP,SP,CP,wP,TP,EP,DP=class extends (hP=ei,mP=[Br(`input[type="checkbox"]`)],pP=[Rr()],fP=[D()],dP=[D()],uP=[D()],lP=[D({reflect:!0})],cP=[D({type:Boolean,reflect:!0})],sP=[D({type:Boolean,reflect:!0})],oP=[Gr(`checked`)],aP=[D({reflect:!0})],iP=[D({type:Boolean,reflect:!0})],rP=[D({attribute:`help-text`})],nP=[Hr(`checked`,{waitUntilFirstUpdate:!0})],tP=[Hr(`disabled`,{waitUntilFirstUpdate:!0})],hP){constructor(){super(...arguments),g(J,5,this),v(this,`formControlController`,new vs(this,{value:e=>e.checked?e.value||`on`:void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=!!t})),v(this,`hasSlotController`,new eo(this,`help-text`)),y(this,gP,g(J,8,this)),g(J,11,this),y(this,_P,g(J,12,this,!1)),g(J,15,this),y(this,vP,g(J,16,this,``)),g(J,19,this),y(this,yP,g(J,20,this,``)),g(J,23,this),y(this,bP,g(J,24,this)),g(J,27,this),y(this,xP,g(J,28,this,`medium`)),g(J,31,this),y(this,SP,g(J,32,this,!1)),g(J,35,this),y(this,CP,g(J,36,this,!1)),g(J,39,this),v(this,`defaultChecked`,g(J,52,this,!1)),g(J,55,this),y(this,wP,g(J,40,this,``)),g(J,43,this),y(this,TP,g(J,44,this,!1)),g(J,47,this),y(this,EP,g(J,48,this,``)),g(J,51,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit(`st-blur`)}handleInput(){this.emit(`st-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit(`st-change`)}handleFocus(){this.hasFocus=!0,this.emit(`st-focus`)}handleKeyDown(e){e.key===`ArrowLeft`&&(e.preventDefault(),this.checked=!1,this.emit(`st-change`),this.emit(`st-input`)),e.key===`ArrowRight`&&(e.preventDefault(),this.checked=!0,this.emit(`st-change`),this.emit(`st-input`))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`help-text`),t=this.helpText?!0:!!e;return T`
      <div
    ...
    `}};J=ge(hP),gP=new WeakMap,_P=new WeakMap,vP=new WeakMap,yP=new WeakMap,bP=new WeakMap,xP=new WeakMap,SP=new WeakMap,CP=new WeakMap,wP=new WeakMap,TP=new WeakMap,EP=new WeakMap,_(J,4,`input`,mP,DP,gP),_(J,4,`hasFocus`,pP,DP,_P),_(J,4,`title`,fP,DP,vP),_(J,4,`name`,dP,DP,yP),_(J,4,`value`,uP,DP,bP),_(J,4,`size`,lP,DP,xP),_(J,4,`disabled`,cP,DP,SP),_(J,4,`checked`,sP,DP,CP),_(J,4,`form`,aP,DP,wP),_(J,4,`required`,iP,DP,TP),_(J,4,`helpText`,rP,DP,EP),_(J,1,`handleCheckedChange`,nP,DP),_(J,1,`handleDisabledChange`,tP,DP),_(J,5,`defaultChecked`,oP,DP),be(J,DP),v(DP,`styles`,[Fr,Zc,eP]);var OP=pr`
  :host {
    display: block;
  }
...
`,PP,FP,IP,LP,RP,zP,BP,VP,HP,UP,WP=class extends (RP=ei,LP=[D({reflect:!0})],IP=[D({reflect:!0})],FP=[D({type:Boolean,reflect:!0})],PP=[D({type:Boolean})],RP){constructor(){super(...arguments),v(this,`localize`,new Bi(this)),y(this,BP,g(zP,8,this,`neutral`)),g(zP,11,this),y(this,VP,g(zP,12,this,`medium`)),g(zP,15,this),y(this,HP,g(zP,16,this,!1)),g(zP,19,this),y(this,UP,g(zP,20,this,!1)),g(zP,23,this)}handleRemoveClick(){this.emit(`st-remove`)}render(){return T`
      <span
        part="base"
    ...
    `}};zP=ge(RP),BP=new WeakMap,VP=new WeakMap,HP=new WeakMap,UP=new WeakMap,_(zP,4,`variant`,LP,WP,BP),_(zP,4,`size`,IP,WP,VP),_(zP,4,`pill`,FP,WP,HP),_(zP,4,`removable`,PP,WP,UP),be(zP,WP),v(WP,`styles`,[Fr,NP]),v(WP,`dependencies`,{"st-icon-button":Js});var GP,KP,qP,JP,YP,XP,ZP,QP,$P,eF,tF,nF,rF,iF,aF,oF,sF,cF,lF,uF,dF,fF,pF,mF,hF,gF,_F,vF,yF,bF,xF,SF,Y,CF,wF,TF,EF,DF,OF,kF,AF,jF,MF,NF,PF,FF,IF,LF,RF,zF,BF,VF,HF,UF,WF,GF,KF,qF,JF,YF,X=class extends (SF=ei,xF=[Br(`.select`)],bF=[Br(`.select__combobox`)],yF=[Br(`.select__display-input`)],vF=[Br(`.select__value-input`)],_F=[Br(`.select__listbox`)],gF=[Rr()],hF=[Rr()],mF=[Rr()],pF=[Rr()],fF=[Rr()],dF=[D()],uF=[Rr()],lF=[D({attribute:`value`})],cF=[D({reflect:!0})],sF=[D()],oF=[D({type:Boolean,reflect:!0})],aF=[D({attribute:`max-options-visible`,type:Number})],iF=[D({type:Boolean,reflect:!0})],rF=[D({type:Boolean})],nF=[D({type:Boolean,reflect:!0})],tF=[D({type:Boolean,reflect:!0})],eF=[D({type:Boolean,reflect:!0})],$P=[D()],QP=[D({reflect:!0})],ZP=[D({attribute:`help-text`})],XP=[D({reflect:!0,converter:fs})],YP=[D({type:Boolean,reflect:!0})],JP=[D()],qP=[Hr(`disabled`,{waitUntilFirstUpdate:!0})],KP=[Hr([`defaultValue`,`value`],{waitUntilFirstUpdate:!0})],GP=[Hr(`open`,{waitUntilFirstUpdate:!0})],SF){constructor(){super(...arguments),g(Y,5,this),v(this,`validade`,new Xc(this,{interacaoEm:[`st-blur`,`st-input`]})),v(this,`hasSlotController`,new eo(this,`help-text`,`label`)),v(this,`localize`,new Bi(this)),v(this,`typeToSelectString`,``),v(this,`typeToSelectTimeout`),v(this,`closeWatcher`),y(this,CF,g(Y,8,this)),g(Y,11,this),y(this,wF,g(Y,12,this)),g(Y,15,this),y(this,TF,g(Y,16,this)),g(Y,19,this),y(this,EF,g(Y,20,this)),g(Y,23,this),y(this,DF,g(Y,24,this)),g(Y,27,this),y(this,OF,g(Y,28,this,!1)),g(Y,31,this),y(this,kF,g(Y,32,this,``)),g(Y,35,this),y(this,AF,g(Y,36,this)),g(Y,39,this),y(this,jF,g(Y,40,this,[])),g(Y,43,this),y(this,MF,g(Y,44,this,!1)),g(Y,47,this),y(this,NF,g(Y,48,this,``)),g(Y,51,this),v(this,`_value`,``),y(this,PF,g(Y,52,this,``)),g(Y,55,this),y(this,FF,g(Y,56,this,`medium`)),g(Y,59,this),y(this,IF,g(Y,60,this,``)),g(Y,63,this),y(this,LF,g(Y,64,this,!1)),g(Y,67,this),y(this,RF,g(Y,68,this,3)),g(Y,71,this),y(this,zF,g(Y,72,this,!1)),g(Y,75,this),y(this,BF,g(Y,76,this,!1)),g(Y,79,this),y(this,VF,g(Y,80,this,!1)),g(Y,83,this),y(this,HF,g(Y,84,this,!1)),g(Y,87,this),y(this,UF,g(Y,88,this,!1)),g(Y,91,this),y(this,WF,g(Y,92,this,``)),g(Y,95,this),y(this,GF,g(Y,96,this,`bottom`)),g(Y,99,this),y(this,KF,g(Y,100,this,``)),g(Y,103,this),y(this,qF,g(Y,104,this,``)),g(Y,107,this),y(this,JF,g(Y,108,this,!1)),g(Y,111,this),y(this,YF,g(Y,112,this,e=>T`
      <st-tag
        part="tag"
        exportparts="
              base:tag__base,
    ...
    `}};Y=ge(SF),CF=new WeakMap,wF=new WeakMap,TF=new WeakMap,EF=new WeakMap,DF=new WeakMap,OF=new WeakMap,kF=new WeakMap,AF=new WeakMap,jF=new WeakMap,MF=new WeakMap,NF=new WeakMap,PF=new WeakMap,FF=new WeakMap,IF=new WeakMap,LF=new WeakMap,RF=new WeakMap,zF=new WeakMap,BF=new WeakMap,VF=new WeakMap,HF=new WeakMap,UF=new WeakMap,WF=new WeakMap,GF=new WeakMap,KF=new WeakMap,qF=new WeakMap,JF=new WeakMap,YF=new WeakMap,_(Y,4,`popup`,xF,X,CF),_(Y,4,`combobox`,bF,X,wF),_(Y,4,`displayInput`,yF,X,TF),_(Y,4,`valueInput`,vF,X,EF),_(Y,4,`listbox`,_F,X,DF),_(Y,4,`hasFocus`,gF,X,OF),_(Y,4,`displayLabel`,hF,X,kF),_(Y,4,`currentOption`,mF,X,AF),_(Y,4,`selectedOptions`,pF,X,jF),_(Y,4,`valueHasChanged`,fF,X,MF),_(Y,4,`name`,dF,X,NF),_(Y,3,`value`,uF,X),_(Y,4,`defaultValue`,lF,X,PF),_(Y,4,`size`,cF,X,FF),_(Y,4,`placeholder`,sF,X,IF),_(Y,4,`multiple`,oF,X,LF),_(Y,4,`maxOptionsVisible`,aF,X,RF),_(Y,4,`disabled`,iF,X,zF),_(Y,4,`clearable`,rF,X,BF),_(Y,4,`open`,nF,X,VF),_(Y,4,`filled`,tF,X,HF),_(Y,4,`pill`,eF,X,UF),_(Y,4,`label`,$P,X,WF),_(Y,4,`placement`,QP,X,GF),_(Y,4,`helpText`,ZP,X,KF),_(Y,4,`form`,XP,X,qF),_(Y,4,`required`,YP,X,JF),_(Y,4,`getTag`,JP,X,YF),_(Y,1,`handleDisabledChange`,qP,X),_(Y,1,`handleValueChange`,KP,X),_(Y,1,`handleOpenChange`,GP,X),be(Y,X),v(X,`styles`,[Fr,Zc,OP]),v(X,`dependencies`,{"st-icon":jo,"st-popup":k,"st-tag":WP}),v(X,`formAssociated`,!0),is(`select.show`,{keyframes:[{opacity:0,scale:.9},{opacity:1,scale:1}],options:{duration:100,easing:`ease`}}),is(`select.hide`,{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.9}],options:{duration:100,easing:`ease`}});var XF=pr`
  :host {
    display: block;
    user-select: none;
    -webkit-user-select: none;
...
`,ZF,QF,$F,eI,tI,nI,rI,iI,aI,oI,sI,cI,lI,uI,dI,fI,pI,mI=class extends (oI=ei,aI=[Br(`.option__label`)],iI=[Rr()],rI=[Rr()],nI=[Rr()],tI=[D({reflect:!0})],eI=[D({type:Boolean,reflect:!0})],$F=[Hr(`disabled`)],QF=[Hr(`selected`)],ZF=[Hr(`value`)],oI){constructor(){super(...arguments),g(sI,5,this),v(this,`localize`,new Bi(this)),v(this,`isInitialized`,!1),y(this,cI,g(sI,8,this)),g(sI,11,this),y(this,lI,g(sI,12,this,!1)),g(sI,15,this),y(this,uI,g(sI,16,this,!1)),g(sI,19,this),y(this,dI,g(sI,20,this,!1)),g(sI,23,this),y(this,fI,g(sI,24,this,``)),g(sI,27,this),y(this,pI,g(sI,28,this,!1)),g(sI,31,this)}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`option`),this.setAttribute(`aria-selected`,`false`)}handleDefaultSlotChange(){this.isInitialized?customElements.whenDefined(`st-select`).then(()=>{let e=this.closest(`st-select`);e&&e.handleDefaultSlotChange()}):this.isInitialized=!0}handleMouseEnter(){this.hasHover=!0}handleMouseLeave(){this.hasHover=!1}handleDisabledChange(){this.setAttribute(`aria-disabled`,this.disabled?`true`:`false`)}handleSelectedChange(){this.setAttribute(`aria-selected`,this.selected?`true`:`false`)}handleValueChange(){typeof this.value!=`string`&&(this.value=String(this.value)),this.value.includes(` `)&&(console.error(`Option values cannot include a space. All spaces have been replaced with underscores.`,this),this.value=this.value.replaceAll(` `,`_`))}getTextLabel(){let e=this.childNodes,t=``;return[...e].forEach(e=>{e.nodeType===Node.ELEMENT_NODE&&(e.hasAttribute(`slot`)||(t+=e.textContent)),e.nodeType===Node.TEXT_NODE&&(t+=e.textContent)}),t.trim()}render(){return T`
      <div
        part="base"
    ...
    `}};sI=ge(oI),cI=new WeakMap,lI=new WeakMap,uI=new WeakMap,dI=new WeakMap,fI=new WeakMap,pI=new WeakMap,_(sI,4,`defaultSlot`,aI,mI,cI),_(sI,4,`current`,iI,mI,lI),_(sI,4,`selected`,rI,mI,uI),_(sI,4,`hasHover`,nI,mI,dI),_(sI,4,`value`,tI,mI,fI),_(sI,4,`disabled`,eI,mI,pI),_(sI,1,`handleDisabledChange`,$F,mI),_(sI,1,`handleSelectedChange`,QF,mI),_(sI,1,`handleValueChange`,ZF,mI),be(sI,mI),v(mI,`styles`,[Fr,XF]),v(mI,`dependencies`,{"st-icon":jo});var hI=`🛒.🍕.☕.🏠.💡.💧.🔌.🚌.⛽.🚗.💊.🏥.🩺.👕.🎁.🎮.🎵.📚.🎓.🏖️.💰.💳.🧾.🐾.📱.💼.💇.🧴.🧺.🏋️.🛡️.🧸`.split(`.`),gI=[[`diaria`,`financeDaily`],[`semanal`,`financeWeekly`],[`mensal`,`financeMonthly`],[`anual`,`financeYearly`]],_I=`••••`,vI={descricao:!1,valor:!1,diaMes:!1};function yI(e){let t=new Date(e),n=String(t.getMonth()+1).padStart(2,`0`),r=String(t.getDate()).padStart(2,`0`);return`${t.getFullYear()}-${n}-${r}`}function bI(e){return yI(e).slice(0,7)}function xI(e){let[t,n,r]=e.split(`-`).map(Number);return new Date(t??1970,(n??1)-1,r??1).getTime()}var SI,CI,wI,TI,EI,DI,OI,kI,AI,jI,MI,Z,NI,PI,FI,II,LI,RI,zI,BI,VI,HI=class e extends (MI=ei,jI=[D({reflect:!0})],AI=[D({type:Array})],kI=[D({type:Array})],OI=[D({type:Array})],DI=[D({type:Array})],EI=[D({reflect:!0})],TI=[D({type:Boolean,reflect:!0})],wI=[D()],CI=[Rr()],SI=[Hr(`vista`,{waitUntilFirstUpdate:!0})],MI){constructor(){super(...arguments),g(Z,5,this),v(this,`localize`,new Bi(this)),y(this,NI,g(Z,8,this,`painel`)),g(Z,11,this),y(this,PI,g(Z,12,this,[])),g(Z,15,this),y(this,FI,g(Z,16,this,[])),g(Z,19,this),y(this,II,g(Z,20,this,[])),g(Z,23,this),y(this,LI,g(Z,24,this,[])),g(Z,27,this),y(this,RI,g(Z,28,this,``)),g(Z,31,this),y(this,zI,g(Z,32,this,!1)),g(Z,35,this),y(this,BI,g(Z,36,this,`BRL`)),g(Z,39,this),y(this,VI,g(Z,40,this,null)),g(Z,43,this)}get aberto(){return this.formulario!==null}novo(){this.vista===`transacoes`&&this.abrir({especie:`transacao`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,vencimento:yI(Date.now()),pago:!1,parte:0}}),this.vista===`categorias`&&this.abrir({especie:`categoria`,dados:{id:0,nome:``,icone:``,cor:`#0d6efd`,limite:``,erroNome:!1}}),this.vista===`recorrencias`&&this.abrir({especie:`recorrencia`,dados:{id:0,descricao:``,valor:``,tipo:`despesa`,categoria:0,periodicidade:`mensal`,diaMes:1,diaSemana:1,gerarComoPago:!1,ativa:!0,erros:vI}})}fechar(){this.formulario!==null&&(this.formulario=null,this.emit(`st-form`,{detail:{aberto:!1}}))}handleVistaChange(){this.fechar()}abrir(e){this.formulario=e,this.emit(`st-form`,{detail:{aberto:!0}})}get mesCorrente(){return this.mes===``?bI(Date.now()):this.mes}dinheiro(e){return this.localize.number(e,{style:`currency`,currency:this.moeda,minimumFractionDigits:2,maximumFractionDigits:2})}cifra(e){return this.oculto?_I:this.dinheiro(e)}data(e){return e===0?`—`:this.localize.date(new Date(e),{dateStyle:`short`})}get simboloDaMoeda(){return new Intl.NumberFormat(this.localize.lang(),{style:`currency`,currency:this.moeda}).formatToParts(0).find(e=>e.type===`currency`)?.value??this.moeda}get separadores(){let e=new Intl.NumberFormat(this.localize.lang(),{minimumFractionDigits:2}).formatToParts(1234.5);return{grupo:e.find(e=>e.type===`group`)?.value??`.`,decimal:e.find(e=>e.type===`decimal`)?.value??`,`}}mascarar(e){let t=e.replace(/\D/g,``).replace(/^0+(?=\d)/,``);if(t===``)return``;let n=t.padStart(3,`0`),r=Number(n.slice(0,-2));return`${this.localize.number(r)}${this.separadores.decimal}${n.slice(-2)}`}desmascarar(e){let{grupo:t,decimal:n}=this.separadores,r=Number(e.split(t).join(``).replace(n,`.`));return Number.isFinite(r)?Math.abs(r):0}valorEmTexto(e){return e===0?``:this.localize.number(e,{minimumFractionDigits:2,maximumFractionDigits:2})}categoriaPorId(e){return this.categorias.find(t=>t.id===e)}partePorId(e){return e===void 0||e===0?void 0:this.partes.find(t=>t.id===e)}get partesOrdenadas(){return[...this.partes].sort((e,t)=>e.nome.localeCompare(t.nome,this.localize.lang(),{sensitivity:`base`}))}get categoriasOrdenadas(){return[...this.categorias].sort((e,t)=>e.nome.localeCompare(t.nome,this.localize.lang(),{sensitivity:`base`}))}get doMes(){return this.transacoes.filter(e=>e.vencimento!==0&&bI(e.vencimento)===this.mesCorrente)}static soma(e){return e.reduce((e,t)=>e+Number(t.valor),0)}corDa(e){let t=this.categoriaPorId(e.categoria);return t!==void 0&&t.cor!==``?t.cor:e.tipo===`receita`?`var(--st-financeiro-receita)`:`var(--st-financeiro-despesa)`}get anosComMovimento(){let e=new Set([new Date().getFullYear(),Number(this.mesCorrente.slice(0,4))]);for(let t of this.transacoes)t.vencimento!==0&&e.add(new Date(t.vencimento).getFullYear());return[...e].sort((e,t)=>t-e)}renderSaldo(){let e=this.transacoes.reduce((e,t)=>e+(t.tipo===`receita`?Number(t.valor):-Number(t.valor)),0);return T`
      <div class="saldo">
              ...
              <span class="limite__topo">
                ...
                <span class="limite__valores">
                  ...
                  ${e.limite===0?E:T`<small>
                        ${this.localize.term(`financeOfLimit`,this.oculto?_I:this.dinheiro(e.limite))}
                      </small>`}
                </span>
              </span>
    ...
    `}salvar(e,t){this.formulario=null,this.emit(`st-form`,{detail:{aberto:!1}}),this.emit(`st-save`,{detail:{especie:e,registro:t}})}renderFormTransacao(e){let t=t=>{this.formulario={especie:`transacao`,dados:{...e,...t}}};return T`
      <div class="formulario">
        ...
        ${this.renderAcoes(()=>this.salvar(`transacao`,{id:e.id,descricao:e.descricao.trim(),valor:this.desmascarar(e.valor),tipo:e.tipo,categoria:Number(e.categoria),vencimento:e.vencimento===``?Date.now():xI(e.vencimento),pago:e.pago,parte:Number(e.parte)}))}
      </div>
        ...
        ${e.map(e=>{let t=e.tipo===`receita`,n=this.categoriaPorId(e.categoria),r=this.partePorId(e.parte),i=this.corDa(e);return T`
            <div class="registro" data-status=${e.pago?`ok`:`pendente`}>
              ...
              <button
                class="registro__alvo"
                type="button"
                @click=${()=>this.abrir({especie:`transacao`,dados:{id:e.id,descricao:e.descricao,valor:this.valorEmTexto(e.valor),tipo:e.tipo,categoria:e.categoria,vencimento:yI(e.vencimento===0?Date.now():e.vencimento),pago:e.pago,parte:e.parte??0}})}
              >
                <span class="registro__topo">
      ...
      <div class="categorias">
        ${this.categoriasOrdenadas.map(e=>T`
            <div class="categoria">
              ...
              ${e.limite>0?T`
                    <span class="discreto">
                      ${this.localize.term(`financeLimitOf`,this.oculto?_I:this.dinheiro(e.limite))}
                    </span>
                  `:E}
              <st-icon-button
                name="pencil"
    ...
    `}nomeDaPeriodicidade(e){let t=gI.find(([t])=>t===e);return t===void 0?e:this.localize.term(t[1])}descreverPeriodo(e){let t=this.nomeDaPeriodicidade(e.periodicidade);return e.periodicidade===`mensal`?`${t} \xB7 ${this.localize.term(`financeDayNum`,e.diaMes)}`:e.periodicidade===`semanal`?`${t} \xB7 ${this.nomeDoDia(e.diaSemana)}`:t}nomeDoDia(e){return this.localize.date(new Date(2001,0,e),{weekday:`long`})}renderFormRecorrencia(e){let t=t=>{this.formulario={especie:`recorrencia`,dados:{...e,...t}}};return T`
      <div class="formulario">
        ...
        >
          ${gI.map(([e,t])=>T`<st-option value=${e}>${this.localize.term(t)}</st-option>`)}
        </st-select>
        ...
        ${this.recorrencias.map(e=>{let t=e.tipo===`receita`;return T`
            <div class="registro" data-status=${e.ativa?`ok`:`pendente`}>
              ...
              <button
                class="registro__alvo"
                type="button"
                @click=${()=>this.abrir({especie:`recorrencia`,dados:{id:e.id,descricao:e.descricao,valor:this.valorEmTexto(e.valor),tipo:e.tipo,categoria:e.categoria,periodicidade:e.periodicidade,diaMes:e.diaMes,diaSemana:e.diaSemana,gerarComoPago:e.gerarComoPago,ativa:e.ativa,erros:vI}})}
              >
                <span class="registro__topo">
                  <span class="registro__titulo">${e.descricao}</span>
                  <span class="registro__valor" data-tom=${e.tipo}>
    ...
    `}renderVista(){let e=this.formulario;return e===null?this.vista===`transacoes`?this.renderTransacoes():this.vista===`categorias`?this.renderCategorias():this.vista===`recorrencias`?this.renderRecorrencias():this.renderPainel():e.especie===`transacao`?this.renderFormTransacao(e.dados):e.especie===`categoria`?this.renderFormCategoria(e.dados):this.renderFormRecorrencia(e.dados)}render(){return T`<div part="base" class="financeiro">${this.renderVista()}</div>`}};Z=ge(MI),NI=new WeakMap,PI=new WeakMap,FI=new WeakMap,II=new WeakMap,LI=new WeakMap,RI=new WeakMap,zI=new WeakMap,BI=new WeakMap,VI=new WeakMap,_(Z,4,`vista`,jI,HI,NI),_(Z,4,`categorias`,AI,HI,PI),_(Z,4,`partes`,kI,HI,FI),_(Z,4,`transacoes`,OI,HI,II),_(Z,4,`recorrencias`,DI,HI,LI),_(Z,4,`mes`,EI,HI,RI),_(Z,4,`oculto`,TI,HI,zI),_(Z,4,`moeda`,wI,HI,BI),_(Z,4,`formulario`,CI,HI,VI),_(Z,1,`handleVistaChange`,SI,HI),be(Z,HI),v(HI,`styles`,[Fr,$N]),v(HI,`dependencies`,{"st-button":I,"st-icon":jo,"st-icon-button":Js,"st-input":P,"st-option":mI,"st-select":X,"st-switch":DP}),HI.define(`st-financeiro`),jo.define(`st-icon`),Js.define(`st-icon-button`),P.define(`st-input`),ai.define(`st-menu`),Zo.define(`st-menu-item`),mI.define(`st-option`),X.define(`st-select`),$a.define(`st-spinner`),DP.define(`st-switch`);var UI=pr`
  :host {
    display: block;
  }
...
`,WI,GI,KI,qI,JI,YI,XI,ZI,QI,$I,eL,tL,nL,rL,iL,aL,oL,sL,cL,lL,uL,dL,fL,pL,mL,hL,gL,_L,vL,yL,bL,Q,xL,SL,CL,wL,TL,EL,DL,OL,kL,AL,jL,ML,NL,PL,FL,IL,LL,RL,zL,BL,VL,HL,UL,WL,GL,KL,$=class extends (bL=ei,yL=[Br(`.textarea__control`)],vL=[Br(`.textarea__size-adjuster`)],_L=[Rr()],gL=[D()],hL=[D()],mL=[D()],pL=[D({reflect:!0})],fL=[D({type:Boolean,reflect:!0})],dL=[D()],uL=[D({attribute:`help-text`})],lL=[D()],cL=[D({type:Number})],sL=[D()],oL=[D({type:Boolean,reflect:!0})],aL=[D({type:Boolean,reflect:!0})],iL=[D({reflect:!0})],rL=[D({type:Boolean,reflect:!0})],nL=[D({type:Number})],tL=[D({type:Number})],eL=[D()],$I=[D({converter:{fromAttribute:e=>e!==`off`,toAttribute:e=>e?`on`:`off`}})],QI=[D()],ZI=[D({type:Boolean})],XI=[D()],YI=[D({type:Boolean,converter:{fromAttribute:e=>!(!e||e===`false`),toAttribute:e=>e?`true`:`false`}})],JI=[D()],qI=[Gr()],KI=[Hr(`disabled`,{waitUntilFirstUpdate:!0})],GI=[Hr(`rows`,{waitUntilFirstUpdate:!0})],WI=[Hr(`value`,{waitUntilFirstUpdate:!0})],bL){constructor(){super(...arguments),g(Q,5,this),v(this,`formControlController`,new vs(this,{assumeInteractionOn:[`st-blur`,`st-input`]})),v(this,`hasSlotController`,new eo(this,`help-text`,`label`)),v(this,`resizeObserver`),y(this,xL,g(Q,8,this)),g(Q,11,this),y(this,SL,g(Q,12,this)),g(Q,15,this),y(this,CL,g(Q,16,this,!1)),g(Q,19,this),y(this,wL,g(Q,20,this,``)),g(Q,23,this),y(this,TL,g(Q,24,this,``)),g(Q,27,this),y(this,EL,g(Q,28,this,``)),g(Q,31,this),y(this,DL,g(Q,32,this,`medium`)),g(Q,35,this),y(this,OL,g(Q,36,this,!1)),g(Q,39,this),y(this,kL,g(Q,40,this,``)),g(Q,43,this),y(this,AL,g(Q,44,this,``)),g(Q,47,this),y(this,jL,g(Q,48,this,``)),g(Q,51,this),y(this,ML,g(Q,52,this,4)),g(Q,55,this),y(this,NL,g(Q,56,this,`vertical`)),g(Q,59,this),y(this,PL,g(Q,60,this,!1)),g(Q,63,this),y(this,FL,g(Q,64,this,!1)),g(Q,67,this),y(this,IL,g(Q,68,this,``)),g(Q,71,this),y(this,LL,g(Q,72,this,!1)),g(Q,75,this),y(this,RL,g(Q,76,this)),g(Q,79,this),y(this,zL,g(Q,80,this)),g(Q,83,this),y(this,BL,g(Q,84,this)),g(Q,87,this),y(this,VL,g(Q,88,this,!0)),g(Q,91,this),y(this,HL,g(Q,92,this)),g(Q,95,this),y(this,UL,g(Q,96,this)),g(Q,99,this),y(this,WL,g(Q,100,this)),g(Q,103,this),y(this,GL,g(Q,104,this,!0)),g(Q,107,this),y(this,KL,g(Q,108,this)),g(Q,111,this),v(this,`defaultValue`,g(Q,112,this,``)),g(Q,115,this)}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>this.setTextareaHeight()),this.updateComplete.then(()=>{this.setTextareaHeight(),this.resizeObserver.observe(this.input)})}firstUpdated(){this.formControlController.updateValidity()}disconnectedCallback(){super.disconnectedCallback(),this.input&&this.resizeObserver?.unobserve(this.input)}handleBlur(){this.hasFocus=!1,this.emit(`st-blur`)}handleChange(){this.value=this.input.value,this.setTextareaHeight(),this.emit(`st-change`)}handleFocus(){this.hasFocus=!0,this.emit(`st-focus`)}handleInput(){this.value=this.input.value,this.emit(`st-input`)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}setTextareaHeight(){this.resize===`auto`?(this.sizeAdjuster.style.height=`${this.input.clientHeight}px`,this.input.style.height=`auto`,this.input.style.height=`${this.input.scrollHeight}px`):this.input.style.height=``}handleDisabledChange(){this.formControlController.setValidity(this.disabled)}handleRowsChange(){this.setTextareaHeight()}async handleValueChange(){await this.updateComplete,this.formControlController.updateValidity(),this.setTextareaHeight()}focus(e){this.input.focus(e)}blur(){this.input.blur()}select(){this.input.select()}scrollPosition(e){if(e){typeof e.top==`number`&&(this.input.scrollTop=e.top),typeof e.left==`number`&&(this.input.scrollLeft=e.left);return}return{top:this.input.scrollTop,left:this.input.scrollTop}}setSelectionRange(e,t,n=`none`){this.input.setSelectionRange(e,t,n)}setRangeText(e,t,n,r=`preserve`){let i=t??this.input.selectionStart,a=n??this.input.selectionEnd;this.input.setRangeText(e,i,a,r),this.value!==this.input.value&&(this.value=this.input.value,this.setTextareaHeight())}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test(`label`),t=this.hasSlotController.test(`help-text`),n=this.label?!0:!!e,r=this.helpText?!0:!!t;return T`
      <div
        part="form-control"
        class=${Vi({"form-control":!0,"form-control--small":this.size===`small`,"form-control--medium":this.size===`medium`,"form-control--large":this.size===`large`,"form-control--has-label":n,"form-control--has-help-text":r})}
      >
    ...
    `}};Q=ge(bL),xL=new WeakMap,SL=new WeakMap,CL=new WeakMap,wL=new WeakMap,TL=new WeakMap,EL=new WeakMap,DL=new WeakMap,OL=new WeakMap,kL=new WeakMap,AL=new WeakMap,jL=new WeakMap,ML=new WeakMap,NL=new WeakMap,PL=new WeakMap,FL=new WeakMap,IL=new WeakMap,LL=new WeakMap,RL=new WeakMap,zL=new WeakMap,BL=new WeakMap,VL=new WeakMap,HL=new WeakMap,UL=new WeakMap,WL=new WeakMap,GL=new WeakMap,KL=new WeakMap,_(Q,4,`input`,yL,$,xL),_(Q,4,`sizeAdjuster`,vL,$,SL),_(Q,4,`hasFocus`,_L,$,CL),_(Q,4,`title`,gL,$,wL),_(Q,4,`name`,hL,$,TL),_(Q,4,`value`,mL,$,EL),_(Q,4,`size`,pL,$,DL),_(Q,4,`filled`,fL,$,OL),_(Q,4,`label`,dL,$,kL),_(Q,4,`helpText`,uL,$,AL),_(Q,4,`placeholder`,lL,$,jL),_(Q,4,`rows`,cL,$,ML),_(Q,4,`resize`,sL,$,NL),_(Q,4,`disabled`,oL,$,PL),_(Q,4,`readonly`,aL,$,FL),_(Q,4,`form`,iL,$,IL),_(Q,4,`required`,rL,$,LL),_(Q,4,`minlength`,nL,$,RL),_(Q,4,`maxlength`,tL,$,zL),_(Q,4,`autocapitalize`,eL,$,BL),_(Q,4,`autocorrect`,$I,$,VL),_(Q,4,`autocomplete`,QI,$,HL),_(Q,4,`autofocus`,ZI,$,UL),_(Q,4,`enterkeyhint`,XI,$,WL),_(Q,4,`spellcheck`,YI,$,GL),_(Q,4,`inputmode`,JI,$,KL),_(Q,1,`handleDisabledChange`,KI,$),_(Q,1,`handleRowsChange`,GI,$),_(Q,1,`handleValueChange`,WI,$),_(Q,5,`defaultValue`,qI,$),be(Q,$),v($,`styles`,[Fr,Zc,UI]),$.define(`st-textarea`),se(`./stratum`);var qL=document.querySelector(`#app`);function JL(e){if(e.modulo===`home`)return{cabecalho:{titulo:n.home.saudacao},conteudo:lN({executar:()=>void tR(!0),ocupado:QL})};if(e.modulo===`hub`){let t=e.args[0]??``;return{cabecalho:{titulo:ZL(t),voltarPara:`home`},conteudo:dN(t)}}let t=Vt(e.modulo);if(t===void 0)return{cabecalho:{titulo:n.erro.naoEncontrado,voltarPara:`home`},conteudo:UM()};let r=YL[t.id];return r===void 0||!Ut(t.id)?{cabecalho:{titulo:t.rotulo,voltarPara:`home`,acoes:XL(t.id,e,void 0)},conteudo:HM(t)}:{cabecalho:{titulo:r.titulo?.(e)??t.rotulo,voltarPara:r.voltarPara?.(e)??`home`,aoVoltar:()=>r.aoVoltar?.(e)??!1,acoes:XL(t.id,e,r.acoes?.(e))},conteudo:r.conteudo(e)}}var YL={anotacoes:up,caderno:Rp,calendario:uh,criacao:Gv,entenda:Gv,cronologia:vy,estudo:xb,financeiro:px,guias:rS,jogo:wC,leitura:Cw,metas:dT,ministerio:zE,perfil:vD,poesia:hO,prep:PA,receitas:Tj,servico:tM,sobre:CM,tutorial:VM};function XL(e,t,r){let i=e!==`tutorial`&&e!==`sobre`&&Ut(`tutorial`)&&t.args.length===0;return b`
    ${r??x}
    ${i?b`
          <st-icon-button
            name="help-circle"
          ...
          ></st-icon-button>
        `:x}
  `}function ZL(e){return Ht(e)?.rotulo??n.erro.naoEncontrado}var QL=!1;function $L(){if(qL===null)return;let e=eR,{cabecalho:n,conteudo:r}=JL(e);document.title=e.modulo===`home`?t.displayName:`${n.titulo} — ${t.displayName}`,Mt(Sn(n,r,$L),qL)}var eR={modulo:`home`,args:[],query:new URLSearchParams};async function tR(e){if(!QL){QL=!0,$L();try{let t=await ln();if(!e)return;t.ok?L(n.home.sincronizado(t.atualizados.length)):L(t.motivo===`offline`?n.home.semRede:n.home.semManifesto,`warning`)}finally{QL=!1,$L()}}}function nR(){qL!==null&&Mt(b`
      <div class="carregando">
        <st-spinner></st-spinner>
        <p>${n.app.carregando}</p>
      </div>
    `,qL)}function rR(e){qL!==null&&Mt(b`
      <div class="aviso">
        <st-icon class="aviso__icone" name="alert-triangle"></st-icon>
        <h2>${n.erro.banco}</h2>
        <pre class="detalhe">${e}</pre>
      </div>
    `,qL)}async function iR(){nR(),qt($L);try{(await r()).persistente||L(n.armazenamento.memoria,`warning`)}catch(e){rR(String(e));return}qL?.removeAttribute(`aria-busy`),Gt(e=>{eR=e,$L(),scrollTo({top:0})}),nn(),tR(!1),cM()}window.__papiro={repositorio:i,navegacao:{MODULOS:It,HUBS:Lt,HOME:Rt}},location.hash===``&&S(`home`),iR();export{sg as a,ug as c,w as d,b as f,cg as i,L as l,pg as n,og as o,mg as r,fg as s,Lg as t,Kd as u};
//# sourceMappingURL=index-BJjGpUu5.js.map